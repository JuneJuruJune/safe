...
/*
		//Test
		System.out.println("=====서비스_예약VO=====");		
		System.out.println("getRmem : "+rvo.getRmem());	
		System.out.println("getSday : "+rvo.getSday());	
		System.out.println("getEday : "+rvo.getEday());	
		System.out.println("getPeoplenum : "+rvo.getPeoplenum());	
		
		System.out.println("=====서비스_결제VO=====");		
		System.out.println("getChtype : "+chvo.getChtype());
		System.out.println("getChpay : "+chvo.getChpay());
*/
//=============================================================
		//예약--------------------------------------------
