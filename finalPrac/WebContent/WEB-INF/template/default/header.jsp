				...
				<div class="header_bottom_border">
					<div class="row align-items-center">
						<div class="col-xl-2 col-lg-2">
							<div class="logo">
								<a href="${ctrpath}/main"> <img src="${path}/img/tour_logo1.png" alt="" onmouseover="this.src='${path}/img/tour_logo2.png'" onmouseout="this.src='${path}/img/tour_logo1.png'">
								</a>
							</div>
						</div>
						<div class="col-xl-6 col-lg-6">
							<div class="main-menu  d-none d-lg-block">
								<nav>
									<ul id="navigation">
										<li><a class="active" href="${ctrpath}/local/localboardList">국내여행</a></li>
										<li><a class="active" href="${ctrpath}/overseas/overseastrip">해외여행</a></li>
										...
										-->
										<li><a class="active" href="${ctrpath}/customernotice/listNo">공지사항</a></li>
										<!-- 관리자 or 호스트만 보기 가능? 	
										...
										<c:choose>
											<c:when test="${sessionScope.sessionID != null }">
												...
												<li><a class="active" href="${ctrpath}/scheduler/schePath"> [ ${sessionScope.sessionName} ]님의 여행 스케줄러</a></li>
												<li><a href="${ctrpath}/diary/diaryList?dwriter=${sessionScope.sessionID}">다이어리</a></li>
											</c:when>
										</c:choose>
									</ul>
								</nav>
									...
									<ul>
										<c:choose>
											...
											<c:when test="${sessionScope.sessionID != null }">
												...
												<li><a href="${ctrpath}/member/mypage?mid=${sessionScope.sessionID}">마이페이지</a></li>
												<li><a href="${ctrpath}/login/logoutProcess">LogOut</a></li>
											</c:when>
											<c:when test="${sessionScope.sessionHID != null }">
												<li><a href="${ctrpath}/calendar/calendarList">예약확인하기</a></li>
												<li><a href="${ctrpath}/host/hostpage?hid=${sessionScope.sessionHID}">호스트페이지</a></li>
						...
						<div class="seach_icon">
							<a data-toggle="modal" data-target="#exampleModalCenter" href="#"> <i class="fa fa-search"></i>
							</a>
						</div>
						<div class="col-12">
