            ...
            function () {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        $('#target').html("");
                        //var e = JSON.stringify(json,['ltitle']);
...
<script>
	...
	$("#savebtn").on('click', function() {
		var scmem = $('#scmem').val();
		var sclist = $('#sortable-list').sortable("toArray").toString();
		var saveAll = {
			'scmem' : scmem,
			'sclist' : sclist,
		};
		...
		$.ajax({
			url : "../schedulerRest/scheduleInsert?sclist="+saveAll.sclist+"&scmem="+saveAll.scmem,
		    //type : "POST",
			//data : saveAll,
