	...
	<div class="container">
		...
		<div class="column3">
			...
			<div id="sortablediv">
				...
				<ul id="sortable">
					<li class="ui-state-default" draggable="true" id="depart"
						style="display: none;"><span
						class="ui-icon ui-icon-arrowthick-2-n-s"></span>출발</li>
					<li class="ui-state-default" draggable="true" id="res1"><span
						class="ui-icon ui-icon-arrowthick-2-n-s"></span>종로 오죽이네</li>
					<li class="ui-state-default" draggable="true" id="res2"><span
						class="ui-icon ui-icon-arrowthick-2-n-s"></span>신촌 카페몬지</li>
					<li class="ui-state-default" draggable="true" id="res3"><span
						class="ui-icon ui-icon-arrowthick-2-n-s"></span>신용산 닭한마리</li>
					<li class="ui-state-default" draggable="true" id="res4"><span
						class="ui-icon ui-icon-arrowthick-2-n-s"></span>용산 몽탄</li>
					<li class="ui-state-default" draggable="true" id="res5"><span
						class="ui-icon ui-icon-arrowthick-2-n-s"></span>강남 알베르</li>
					<li class="ui-state-default" draggable="true" id="home"
						style="display: none;"><span
